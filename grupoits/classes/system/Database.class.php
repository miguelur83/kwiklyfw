...
class Database{
  ...
  public function select($fields, $table, $conditions="", $limit='', $orderby=''){
  ...
  protected function getDBType($type){
    switch ($type){
      ...
      case 'sorter': case 'int': $db_type = "INT"; break;
      ...
      case 'collector': $db_type = "INT"; break;
      case 'options': $db_type = "INT"; break;
	  // Some custom types
      ...
      case 'logo_winery': $db_type = "VARCHAR (255)"; break;
      case 'bottle_image': $db_type = "VARCHAR (255)"; break;
      case 'flag_image': $db_type = "VARCHAR (255)"; break;
      case 'imagen_marquesina': $db_type = "VARCHAR (255)"; break;
      case 'banner_home': $db_type = "VARCHAR (255)"; break;
      case 'banner_titulo': $db_type = "VARCHAR (255)"; break;

...
class Wine extends KwikObject{ 
  ...
  function __construct($id = 0){
    ...
    $this->field_types["bottle_image"] = "file";
    $this->field_types["ordernum"] = "string";
    $this->field_types["line"] = "object";    
    $this->field_types["PDF_card_file"] = "file";       
    ...
    $this->validation["bottle_image"] = "file";   
    $this->validation["ordernum"] = "string";
    $this->validation["line"] = "Nto1";
    $this->validation["PDF_card_file"] = "file";
